...
class AddressControllerTests {
    ...
    void UserByIdTest() throws Exception {
        ...
        mockMvc.perform(get("http://service.bootcamp61.ga:8080/address/1")
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
    }
    ...
    void JobByIdTestException() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                ...
                .andExpect(res -> assertTrue(res.getResolvedException() instanceof AddressNotFoundException))
                .andExpect(res -> assertEquals("Address with id - 3 not found", res.getResolvedException().getMessage()))
    ...
    void createUserTest() throws Exception {
        ...
        when(addressService.save(address)).thenReturn(Address1);
